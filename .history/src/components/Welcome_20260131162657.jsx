            ...
            >
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <h1
                            className="text-4xl md:text-5xl font-extrabold leading-tight mb-4 heading reveal-left">
                        ...
                        {/* <button
                            ...
                            className="px-8 py-3 rounded-full text-white font-semibold transition hover:scale-105 color-buttons"
                        >
                        Portfolio →
                        </button> */}
                    </div>

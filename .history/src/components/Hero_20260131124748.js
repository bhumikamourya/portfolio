        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <button
                className="px-4 py-2 rounded-full border border-slate-200  hover:bg-slate-100 transition subheading">
                Download CV
              </button>
            </div>
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              className="cursor-pointer hover:underline cursor-pointer">GitHub</a>
          ...
          <div className="flex justify-center">
            ...
            >
              <img
                ...
                className="w-85 h-80 object-cover rounded-2xl"
              />
            </div>
          </div>
